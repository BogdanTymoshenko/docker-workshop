...
```
docker run -d --name test-nginx -v ./examples/nginx:/usr/share/nginx/html:ro nginx:latest
```
...
Links: [docker info](https://docs.docker.com/engine/reference/commandline/info/) | [Managing data in Docker volumes](https://docs.docker.com/engine/tutorials/dockervolumes/)
